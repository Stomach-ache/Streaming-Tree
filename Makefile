...
bonsai_train: helpers.o bonsai_train.cpp bonsai.cpp bonsai_update.cpp
	$(CXX) -o bonsai_train $(CXXFLAGS) $(INC) bonsai_train.cpp bonsai.cpp bonsai_update.cpp helpers.o $(LIBFLAGS)
